...
import { ifindustries, invoices, invoiceFastApp } from '../Variables'
...
const InvoiceFactoringApp = ( { credentials, fieldData } ) => {
  ...
  const onSubmit = data => {
    ...
    requestForm[45] = window.location.href //full path embed url
    ...
    axios
      .post('https://ada-kapitus.com//next-js/applynow.php', {"formData": requestForm, 'fileData': multipleFiles}, config)
      .then(response => {
