    ...
    <AnimatePresence>
      ...
      <form autoComplete="off">
        <div className={`flex flex-col mb-4 ${error ? `gfield-error` : ``}`}>
          ...
          <input className="border-solid border-2 border-light-blue-500 h-16 bg-kapitus text-white text-2xl p-2" type="text" name="address" onBlur={handleBlur} onChange={event => handleChange(event)} value={gffund} />
