        ...
        <div className="relative w-full bg-white max-w-3xl">
          ...
          <div className="flex place-items-center">
            <div className="px-10 md:grid md:grid-cols-2 gap-2 w-full">
              ...
              <div className="col-span-2 mb-2">
              <input type="submit" className="h-12 w-full text-white rounded bg-kapitusLiteGreen hover:bg-green-700 transition duration-900 ease-in-out cursor h-20 text-lg" value="Call Me" />
              </div>
            </div>
            <div className="hidden md:block"><Image alt="contact-us" width="470" height="1200" src="/images/Pop-Over.jpg" className="w-full h-full" /></div>
          </div>
        </div></div></div></form>):'';
}
