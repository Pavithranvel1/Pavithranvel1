...
import { aboutUs, industries, invoices, contact, invoiceForm } from '../Variables'
      ...
      .then(response => {
        if(response.data) {
          if(data.sales == 'complete the full application'){
            ...
            router.push(`/invoice-factoring-application?${res}`)
          }
          else {
...
/* 
  ...
  return (
    <section className="w-full max-w-4xl mt-2 px-10 m-auto invoiceShort">
