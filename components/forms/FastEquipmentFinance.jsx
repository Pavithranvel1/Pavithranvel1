...
import { aboutUs, equipIndustries, states, days, months, years, entities, creditScores, equipFastApp } from '../Variables'
...
export default function FastEquipmentFinance({
    credentials,
    fieldData
  }) {
  ...
  const onSubmit = data => {
    ...
    requestForm[55] = window.location.href //full path embed url
  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-4 max-w-4xl m-auto">
      ...
      <div className="col-span-2 md:col-span-1">
        ...
        <button type="button" className="col-span-2 w-72 sm:w-full bg-white p-0 mt-0 relative refresh" onClick={event => handleClear(event, padRef)}><Image alt="refresh" width="30" height="30" src="/images/refresh.png" {...commonname} className="float-right bg-contain inline-block h-8 w-8 bg-no-repeat" /></button>
