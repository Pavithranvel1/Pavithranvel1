  ...
  return (
    <div className="bg-kapitus py-10 px-10 m-auto w-full">
      ...
      <div className="max-w-4xl m-auto text-center">
        ...
        <div className="text-left"><span className="text-white">• 650+ Credit Score 3+ Years in Business Required</span></div>
        <div className="text-left"><span className="text-white">• Truck/Vehicle Financing currently unavailable</span></div>
        </div>
        </section>
        </div>
      </div>
