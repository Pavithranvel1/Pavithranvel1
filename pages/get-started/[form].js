...
const Getstarted = () => {
  ...
  //setStep(formStep)
  return (
    <motion.div className="p-4 px-8 pb-8 bg-kapitus relative min-h-full overflow-auto" drag="y" dragConstraints={{ top: 0, bottom:0 }} onDrag={onDrag} style={{height: '814px'}}>
      <Head>
