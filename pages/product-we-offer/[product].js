...
export default function Product() {
  ...
  return (<AnimatePresence>
    {showlearn && product1 && (<>
      ...
      <motion.div drag="y" dragConstraints={{ top: 0, bottom:0 }} onDrag={onDrag} className="overlay"  initial="initial" animate="animate">
      <motion.div className="grid fixed z-40 cursor-pointer text-white place-items-center w-full h-12 bg-kapitus capitalize text-lg" onClick={closeModal} initial={{ y: -350, opacity: 0 }} animate={{ y: 0, opacity: 1, transition: { delay: .3, ...transition }}} exit={{ y: -350, opacity: 0, transition: { delay: 0.2, duration: .5 }}} whileTap={{scale:.95}}>
